...
A simple, static single-page wedding website for Vijay & Samyuktha with a peacock/floral Indian theme. No build step, no dependencies — just `index.html`, `styles.css`, `script.js`, the monogram assets (`favicon.svg`, `logo.svg`), and decorative artwork (`hero-flourish.webp`, `divider.webp`).
